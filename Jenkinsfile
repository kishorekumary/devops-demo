    ...
    stages {
            ...
            stage('Sonarqube Scanning') {
                ...
                steps {
                    ...
                    sh '''cd backend && sudo mvn clean verify sonar:sonar -Dsonar.projectKey=project-4-backen   -Dsonar.host.url=http://20.20.4.29:9000 -Dsonar.login=sqp_252ed1ee03105eb70213bbfc1665f3c902706e59'''
                }
            }
